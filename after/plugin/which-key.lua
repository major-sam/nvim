...
wk.add({
	...
	-- REPL
	{
		...
		icon = "",
		function()
			iron_core.repl_restart()
		end,
		desc = "REPL(iron) Restarts",
	},
	...
	{ "<leader>re", icon = "", "<cmd>VenvSelect<cr>", desc = "REPL venv-selector" },
	{
		...
		mode = { "v", "x" },
		desc = "REPL(iron) send selected text",
	},
	{
		"<leader>rs",
		icon = "󱀹",
		...
		desc = "REPL(iron) send current file",
	},
	{
		"<leader>rS",
		icon = "󱀹",
	...
	{ "<leader>rK", icon = "", py.show_description, desc = "Show package PyPI description" },
	{
		...
		icon = "",
		function()
			iron_core.close_repl()
		end,
		desc = "REPL(iron) Close Repl",
	},
	-- Trouble
